...
namespace Store.Core.Application.Contexts.Store.OrderedProducts.Commands.PostOrderedProduct
{
    ...
    {
        public PostOrderedProductCommandResponse(Tuple<int, int, WrapRequest<OrderedProduct>, Dictionary<string, object>, Dictionary<string, object>, string, long?> tuple) : base(tuple)
        {
        }
