...
namespace Store.Core.Application.Contexts.Store.OrderedProducts.Commands.PatchOrderedProduct
{
    ...
    {
        public PatchOrderedProductCommandResponse(Tuple<int, int, WrapRequest<OrderedProduct>, Dictionary<string, object>, Dictionary<string, object>, string, long?> tuple) : base(tuple)
        {
        }
